...
Доступно формирование описания формата загрузки в виде markdown. Для просмотра файла можно установить редактор [Typora](https://typora.io/).<br>
Описание формата строится от интерфейсных подсистем. В качестве объектов конфигурации выводятся синонимы.
