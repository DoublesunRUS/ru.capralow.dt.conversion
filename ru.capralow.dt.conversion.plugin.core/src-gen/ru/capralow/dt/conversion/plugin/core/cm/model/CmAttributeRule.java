...
public interface CmAttributeRule extends EObject {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Configuration Tabular Section</em>' attribute isn't clear,
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Configuration Attribute</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Format Tabular Section</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Format Attribute</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='&lt;%java.lang.String%&gt; result = this.getConfigurationAttribute();\nint _length = this.getConfigurationTabularSection().length();\nboolean _notEquals = (_length != 0);\nif (_notEquals)\n{\n\t&lt;%java.lang.String%&gt; _configurationTabularSection = this.getConfigurationTabularSection();\n\t&lt;%java.lang.String%&gt; _plus = (_configurationTabularSection + \".\");\n\t&lt;%java.lang.String%&gt; _plus_1 = (_plus + result);\n\tresult = _plus_1;\n}\nreturn result;'"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @model kind="operation" unique="false"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='&lt;%java.lang.String%&gt; result = this.getFormatAttribute();\nint _length = this.getFormatTabularSection().length();\nboolean _notEquals = (_length != 0);\nif (_notEquals)\n{\n\t&lt;%java.lang.String%&gt; _formatTabularSection = this.getFormatTabularSection();\n\t&lt;%java.lang.String%&gt; _plus = (_formatTabularSection + \".\");\n\t&lt;%java.lang.String%&gt; _plus_1 = (_plus + result);\n\tresult = _plus_1;\n}\nreturn result;'"
	 * @generated
	 */
