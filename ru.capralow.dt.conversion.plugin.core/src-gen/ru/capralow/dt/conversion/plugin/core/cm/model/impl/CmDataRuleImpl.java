 ...
 * </p>
 * <ul>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmDataRuleImpl#getName <em>Name</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmDataRuleImpl#getIsDisabled <em>Is Disabled</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmDataRuleImpl#getConfigurationObject <em>Configuration Object</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmDataRuleImpl#getConfigurationObjectName <em>Configuration Object Name</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmDataRuleImpl#getConfigurationObjectFormattedName <em>Configuration Object Formatted Name</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmDataRuleImpl#getFormatObject <em>Format Object</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmDataRuleImpl#getForSending <em>For Sending</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmDataRuleImpl#getForReceiving <em>For Receiving</em>}</li>
...
public class CmDataRuleImpl extends MinimalEObjectImpl.Container implements CmDataRule {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, cmPackage.CM_DATA_RULE__NAME, oldName, name));
	}
	...
	public MdObject getConfigurationObject() {
		if (configurationObject != null && configurationObject.eIsProxy()) {
			...
			if (configurationObject != oldConfigurationObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, cmPackage.CM_DATA_RULE__CONFIGURATION_OBJECT, oldConfigurationObject, configurationObject));
			}
		}
	...
	public void setConfigurationObject(MdObject newConfigurationObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, cmPackage.CM_DATA_RULE__CONFIGURATION_OBJECT, oldConfigurationObject, configurationObject));
	}
	...
	public void setConfigurationObjectName(String newConfigurationObjectName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, cmPackage.CM_DATA_RULE__CONFIGURATION_OBJECT_NAME, oldConfigurationObjectName, configurationObjectName));
	}
	...
	public void setFormatObject(String newFormatObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, cmPackage.CM_DATA_RULE__FORMAT_OBJECT, oldFormatObject, formatObject));
	}
	...
	public void setForSending(Boolean newForSending) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, cmPackage.CM_DATA_RULE__FOR_SENDING, oldForSending, forSending));
	}
	...
	public void setForReceiving(Boolean newForReceiving) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, cmPackage.CM_DATA_RULE__FOR_RECEIVING, oldForReceiving, forReceiving));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case cmPackage.CM_DATA_RULE__NAME:
				return getName();
			case cmPackage.CM_DATA_RULE__IS_DISABLED:
				return getIsDisabled();
			case cmPackage.CM_DATA_RULE__CONFIGURATION_OBJECT:
				if (resolve) return getConfigurationObject();
				return basicGetConfigurationObject();
			case cmPackage.CM_DATA_RULE__CONFIGURATION_OBJECT_NAME:
				return getConfigurationObjectName();
			case cmPackage.CM_DATA_RULE__CONFIGURATION_OBJECT_FORMATTED_NAME:
				return getConfigurationObjectFormattedName();
			case cmPackage.CM_DATA_RULE__FORMAT_OBJECT:
				return getFormatObject();
			case cmPackage.CM_DATA_RULE__FOR_SENDING:
				return getForSending();
			case cmPackage.CM_DATA_RULE__FOR_RECEIVING:
