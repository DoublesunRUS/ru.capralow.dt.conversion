...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ep Project Status</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see ru.capralow.dt.conversion.plugin.core.ep.model.epPackage#getEpProjectStatus()
 * @model
 * @generated
 */
public enum EpProjectStatus implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Ep Project Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final EpProjectStatus[] VALUES_ARRAY =
		new EpProjectStatus[] {
			NO_CONFIGURATION,
			NO_SUBSYSTEM,
			NO_SSL_VERSION,
	...
	/**
	 * A public read-only list of all the '<em><b>Ep Project Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<EpProjectStatus> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Ep Project Status</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static EpProjectStatus get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			EpProjectStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Ep Project Status</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static EpProjectStatus getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			EpProjectStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Ep Project Status</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static EpProjectStatus get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private EpProjectStatus(int value, String name, String literal) {
		this.value = value;
		this.name = name;
