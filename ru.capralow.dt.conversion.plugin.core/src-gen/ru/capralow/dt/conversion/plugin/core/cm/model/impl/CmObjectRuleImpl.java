 ...
 * </p>
 * <ul>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmObjectRuleImpl#getName <em>Name</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmObjectRuleImpl#getIsDisabled <em>Is Disabled</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmObjectRuleImpl#getConfigurationObject <em>Configuration Object</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmObjectRuleImpl#getConfigurationObjectName <em>Configuration Object Name</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmObjectRuleImpl#getConfigurationObjectFormattedName <em>Configuration Object Formatted Name</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmObjectRuleImpl#getFormatObject <em>Format Object</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmObjectRuleImpl#getForSending <em>For Sending</em>}</li>
 *   <li>{@link ru.capralow.dt.conversion.plugin.core.cm.model.impl.CmObjectRuleImpl#getForReceiving <em>For Receiving</em>}</li>
...
public class CmObjectRuleImpl extends MinimalEObjectImpl.Container implements CmObjectRule {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, cmPackage.CM_OBJECT_RULE__NAME, oldName, name));
	}
	...
	public MdObject getConfigurationObject() {
		if (configurationObject != null && configurationObject.eIsProxy()) {
			...
			if (configurationObject != oldConfigurationObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, cmPackage.CM_OBJECT_RULE__CONFIGURATION_OBJECT, oldConfigurationObject, configurationObject));
			}
		}
	...
	public void setConfigurationObject(MdObject newConfigurationObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, cmPackage.CM_OBJECT_RULE__CONFIGURATION_OBJECT, oldConfigurationObject, configurationObject));
	}
	...
	public void setConfigurationObjectName(String newConfigurationObjectName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, cmPackage.CM_OBJECT_RULE__CONFIGURATION_OBJECT_NAME, oldConfigurationObjectName, configurationObjectName));
	}
	...
	public void setFormatObject(String newFormatObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, cmPackage.CM_OBJECT_RULE__FORMAT_OBJECT, oldFormatObject, formatObject));
	}
	...
	public void setForSending(Boolean newForSending) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, cmPackage.CM_OBJECT_RULE__FOR_SENDING, oldForSending, forSending));
	}
	...
	public void setForReceiving(Boolean newForReceiving) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, cmPackage.CM_OBJECT_RULE__FOR_RECEIVING, oldForReceiving, forReceiving));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case cmPackage.CM_OBJECT_RULE__NAME:
				return getName();
			case cmPackage.CM_OBJECT_RULE__IS_DISABLED:
				return getIsDisabled();
			case cmPackage.CM_OBJECT_RULE__CONFIGURATION_OBJECT:
				if (resolve) return getConfigurationObject();
				return basicGetConfigurationObject();
			case cmPackage.CM_OBJECT_RULE__CONFIGURATION_OBJECT_NAME:
				return getConfigurationObjectName();
			case cmPackage.CM_OBJECT_RULE__CONFIGURATION_OBJECT_FORMATTED_NAME:
				return getConfigurationObjectFormattedName();
			case cmPackage.CM_OBJECT_RULE__FORMAT_OBJECT:
				return getFormatObject();
			case cmPackage.CM_OBJECT_RULE__FOR_SENDING:
				return getForSending();
			case cmPackage.CM_OBJECT_RULE__FOR_RECEIVING:
