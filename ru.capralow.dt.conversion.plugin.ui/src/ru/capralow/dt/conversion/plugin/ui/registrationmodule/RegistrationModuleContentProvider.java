package ru.capralow.dt.conversion.plugin.ui.registrationmodule;
...
public class RegistrationModuleContentProvider implements ITreeContentProvider {
	...
	public Object[] getElements(Object registrationModule) {
		EList<ExchangePlanContent> exchangePlanContents = ((RegistrationModule) registrationModule)
		...
		// contentMap.put("root1", new String[] { "root1_child1", "root1_child2",
		// "root1_child3" });
		// contentMap.put("root1_child1", new String[] { "root1_child1_child1",
		// "root1_child1_child2" });
