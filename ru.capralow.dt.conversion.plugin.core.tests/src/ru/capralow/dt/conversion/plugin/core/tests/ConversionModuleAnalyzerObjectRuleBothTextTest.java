...
public class ConversionModuleAnalyzerObjectRuleBothTextTest {
	...
	private static final String ON_SENDING_EVENT_SECTION = String.join(LS,
			"_ПриОтправкеДанных(ДанныеИБ, ДанныеXDTO, КомпонентыОбмена, СтекВыгрузки)",
			ON_SENDING_EVENT_TEXT,
			END_OF_PROCEDURE);
	...
	public void testEvent1() {
		...
		String report1 = String.join(LS,
				String.format(BEGIN_OF_REGION, ruleName),
				String.format(BEGIN_OF_PROCEDURE, ruleName),
				"",
				NEW_RULE,
				String.format(RULE_NAME, ruleName),
		...
		ConversionModuleAnalyzerUtils.addObjectRuleEvents(true, false, false, "", "", objectRule, null);
	...
	public void testEvent12() {
		...
		ConversionModuleAnalyzerUtils.addObjectRuleEvents(true, true, false, "", "", objectRule, null);
	...
	public void testEvent123() {
		...
		String report1 = String.join(LS,
				...
				String.format(ON_SENDING_EVENT_DECLARATION, ruleName),
				String.format(BEFORE_RECEIVING_EVENT_DECLARATION, ruleName),
				String.format(ON_RECEIVING_EVENT_DECLARATION, ruleName),
				IDENTIFICATION_UUID,
				"	",
				"",
				END_OF_PROCEDURE,
				...
				String.format(BEGIN_OF_EVENT_PROCEDURE, ruleName, BEFORE_RECEIVING_EVENT_SECTION),
				"",
				String.format(BEGIN_OF_EVENT_PROCEDURE, ruleName, ON_RECEIVING_EVENT_SECTION),
				END_OF_REGION);

		StringBuilder report2 = new StringBuilder();
		CmObjectRule objectRule = ConversionModuleAnalyzerUtils
				.addFilledObjectRule("ПКООтправкиПолученияСобытие123", false, false, true, true, false, null);
		ConversionModuleAnalyzerUtils.addObjectRuleEvents(true, true, true, "", "", objectRule, null);
	...
	public void testEvent13() {
		...
		ConversionModuleAnalyzerUtils.addObjectRuleEvents(true, false, true, "", "", objectRule, null);
	...
	public void testFull() {
		...
		StringBuilder report2 = new StringBuilder();
		CmObjectRule objectRule = ConversionModuleAnalyzerUtils
				.addFilledObjectRule("ПКООтправкиПолученияПолное", true, true, true, true, true, null);
		ConversionModuleAnalyzerUtils.addObjectRuleEvents(true,
				true,
				true,
				AFTER_RECEIVING_ALGORITHM_NAME,
