...
public class ConversionModuleAnalyzerSimpleGetTextTest {
	...
	public void testFullV2() {
		...
		ConversionModuleAnalyzerUtils
				.addFilledObjectRule("МинимальноеПКООтправки", false, false, true, false, false, objectRules);
		...
		ConversionModuleAnalyzerUtils
				.addFilledObjectRule("МинимальноеПКОПолучения", false, false, false, true, false, objectRules);

		ConversionModuleAnalyzerUtils
				.addFilledObjectRule("МинимальноеПКОПолученияДляГруппы", false, false, false, true, true, objectRules);
		...
		ConversionModuleAnalyzerUtils
				.addFilledObjectRule("МинимальноеПКООтправкиПолучения", false, false, true, true, false, objectRules);
		...
		ConversionModuleAnalyzerUtils
				.addFilledPredefined("МинимальноеПКПДОтправкиПолучения", false, true, true, predefineds);
