...
public class ConversionModuleAnalyzerObjectRuleSendingTextTest {
	...
	public void testConfigurationFormatObject() {
		...
		ConversionModuleAnalyzer.createObjectRuleSendingText(objectRule, report2);
	...
	public void testEvent() {
		String report1 = String.join(LS,
				...
				END_OF_PROCEDURE,
				"",
				"Процедура ПКО_ПКООтправкиСобытие1".concat(ON_SENDING_EVENT_SECTION),
				END_OF_REGION);
	...
	public void testFull() {
		String report1 = String.join(LS,
				...
				END_OF_PROCEDURE,
				"",
				"Процедура ПКО_ПКООтправкиПолное".concat(ON_SENDING_EVENT_SECTION),
				END_OF_REGION);

		StringBuilder report2 = new StringBuilder();
		CmObjectRule objectRule = ConversionModuleAnalyzerUtils
				.addFilledObjectRule("ПКООтправкиПолное", true, true, true, false, false, null);
		ConversionModuleAnalyzerUtils.addObjectRuleEvents(true, false, false, "", "", objectRule, null);
		ConversionModuleAnalyzerUtils.addHeader(objectRule);
	...
	public void testHeaderAndTabularSection() {
		...
		StringBuilder report2 = new StringBuilder();
		CmObjectRule objectRule = ConversionModuleAnalyzerUtils
				.addFilledObjectRule("ПКООтправкиШапкаТЧ", true, true, true, false, false, null);
		ConversionModuleAnalyzerUtils.addHeader(objectRule);
		ConversionModuleAnalyzerUtils.addTabularSection1(objectRule);
	...
	public void testTwoTabularSections() {
		...
		StringBuilder report2 = new StringBuilder();
		CmObjectRule objectRule = ConversionModuleAnalyzerUtils
				.addFilledObjectRule("ПКООтправкиДвеТЧ", true, true, true, false, false, null);
		ConversionModuleAnalyzerUtils.addTabularSection1(objectRule);
		ConversionModuleAnalyzerUtils.addTabularSection2(objectRule);
